...
def main():
    ...
    model_args.output_dir = os.path.join(model_args.output_dir, model_args.dataset_name, model_args.model_name_or_path.split('/')[-1],
                                   f"bit{model_args.num_bits}", f"iter{model_args.num_iter}", f"rank{model_args.reduced_rank}",
                                   f"lr_{model_args.learning_rate}", f"seed{model_args.seed}")
